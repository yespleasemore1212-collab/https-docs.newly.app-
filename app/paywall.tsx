...
const FEATURES = [
  {
    icon: "👑",
    title: "Join Premium Communities",
    description: "Access exclusive creator communities and paid memberships",
  },
  {
    icon: "⚡",
    title: "Premium Content Access",
    description: "Unlock exclusive posts, videos, and creator content",
  },
  {
    icon: "💬",
    title: "Direct Creator Messaging",
    description: "Message top creators directly with priority responses",
  },
  {
    icon: "🎯",
    title: "Elite Member Badge",
    description: "Stand out with a verified Elite badge on your profile",
  },
];
